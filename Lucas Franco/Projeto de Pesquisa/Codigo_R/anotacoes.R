# FASE 1
# passo 1 - Carregar a base de dados (todos os PD)
# passo 2 - tratamento dos dados (todos PD)
# passo 3 - nuvem de palavras (cada PD)
# passo 4 - juntar todos os PD (todos PD)
# passo 5 - nuvem de palavras (todos PD)
# passo 6 - semelhança e diferença entre os pd
# passo 7 - bi-grama, trigrama e rede para cada pd
# passo 8 - IF-tdf para cada pd
# FASE 2 
# Rio de Janeiro com o seu passado
...
PD_rio_2011 <-readtext("C:/Users/Hp/Desktop/TCC UNIRIO/Lucas Franco/Projeto de Pesquisa/Planos Diretores/TXT/rio_de_janeiro_2011.txt",encoding="UTF-8")


library(dplyr)
rio_e_nit <- PD_rio_2011 %>% add_row(PD_nikiti_2019)
