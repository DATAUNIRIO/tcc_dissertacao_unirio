...
library(readtext)
PD_itaborai_2019 <-readtext("C:/Users/Luc/Desktop/Projeto e TCC/tcc/Planos Diretores/TXT/itaborai_2019.txt",encoding="UTF-8")

# Jogar fora o excesso
PD_itaborai_2019 <- PD_itaborai_2019$text

#  Colocar em minusculo
PD_itaborai_2019 <- tolower(PD_itaborai_2019)

# Substituir o caracter especial
library(stringr)
banco<-str_trim(PD_itaborai_2019)
head(banco)
...
palavras_banidas<-c("\ni","i","ii","iii","iv","v","vi","vii","viii","ix","art","x","xi","xii","xiii","iii-","i-","ii-","iv-","n-","e-","ponto","coordenadas","utm","deste","seguindo","direção","linha","reta","metros","excluída","partindo",
                    "e","é", "de", "o", "a", "com", "que", "do", "um", "para", "uma", "no", "em", "os", "da", "pelo", "ao", "mas", "nos", "na", "ser", "as", "por","c","d","b","m","faz",
